<%@ Page Language="C#" AutoEventWireup="true" CodeFile="point.aspx.cs" Inherits="CMSView_point" MasterPageFile="~/MasterPage/CMSMasterPage.Master" %>
                    ...
                    <div class="row ">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                            ...
                            <div class="input-group">
                                <input type="number" class="form-control" aria-label="Target EC" aria-describedby="txt_target" >
                            </div>
                        </div>
                    </div>
